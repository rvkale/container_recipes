...
-DPyTrilinos_ENABLE_Epetra=ON \
-DPyTrilinos_ENABLE_Triutils=ON \
-DPyTrilinos_ENABLE_Tpetra=ON \
-DPyTrilinos_ENABLE_Domi=ON \
-DPyTrilinos_ENABLE_EpetraExt=ON \
-DPyTrilinos_ENABLE_Isorropia=ON \
-DPyTrilinos_ENABLE_Pliris=ON \
-DPyTrilinos_ENABLE_AztecOO=ON \
-DPyTrilinos_ENABLE_Galeri=ON \
-DPyTrilinos_ENABLE_Amesos=ON \
-DPyTrilinos_ENABLE_Ifpack=ON \
-DPyTrilinos_ENABLE_Komplex=ON \
-DPyTrilinos_ENABLE_Anasazi=ON \
-DPyTrilinos_ENABLE_ML=ON \
-DPyTrilinos_ENABLE_NOX=ON \
-DPyTrilinos_INSTALL_PREFIX=/usr/local/pytrilinos/12.18.1 \
$SRCDIR && \
make -j$(nproc) all && \
make install
